...
public class FacturaServiceImpl implements FacturaService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try{
            ...
            if(validateRequestMap(requestMap)){
                ...
                JSONArray jsonArray = FacturaUtils.getJsonArrayFromString(String.valueOf(requestMap.get("productoDetalles")));
    ...
    public ResponseEntity<byte[]> getPDF(Map<String, Object> requestMap) {
        log.info("Get PDF - RequestMap( "+requestMap+" )");
        try {
            ...
            if(FacturaUtils.isFieldExist(filePath)){
    ...
    public ResponseEntity<String> deleteFactura(Integer id) {
        try {
            ...
            if(!optional.isEmpty()) {
                ...
                return FacturaUtils.getResponseEntity("Factura Eliminada", HttpStatus.ACCEPTED);
            }
            return FacturaUtils.getResponseEntity("Id de factura no existe", HttpStatus.NOT_FOUND);
        } catch (Exception e) {
            e.printStackTrace();
        }    
        return FacturaUtils.getResponseEntity(FacturaConstantes.SOMETHING_WENT_WRONG, HttpStatus.INTERNAL_SERVER_ERROR);
